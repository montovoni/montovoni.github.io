...
2. Suba estes 3 arquivos (`index.html`, `style.css`, `script.js`) para a raiz do repositório.
3. Vá em **Settings → Pages**, escolha a branch `main` e a pasta `/ (root)`, salve.
4. Em alguns minutos o site fica no ar em `https://SEU-USUARIO.github.io` (se usou o nome especial) ou `https://SEU-USUARIO.github.io/nome-do-repo`.
